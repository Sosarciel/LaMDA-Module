...
/**创建测试对话结构体 */
export const createTestConversation = (options?: {
...
/**创建测试消息结构体 */
export const createTestMessage = (conversationId: string, options?: {
    message_id?: string;
...
/**创建测试对话结构体（泛型版本） */
export const createTestConversationGeneric = <TConv extends ConversationStructExt = {m_light:{}, m_heavy:{}, c_light:{}, c_heavy:{}}>(
    options?: {
        conversation_id?: string;
...
/**创建测试消息结构体（泛型版本） */
export const createTestMessageGeneric = <TMsg extends MessageStructExt = {m_light:{}, m_heavy:{}}>(
